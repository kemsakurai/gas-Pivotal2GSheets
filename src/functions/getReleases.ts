...
const setValuesToReleasesSheet = releasesWithFailureFlag => {
    ...
    for (const releaseWithFailureFlag of releasesWithFailureFlag) {
        ...
        columns.push(releaseWithFailureFlag.created_at);
        columns.push(releaseWithFailureFlag.updated_at);
        columns.push(releaseWithFailureFlag.accepted_at);
        columns.push(releaseWithFailureFlag.deadline);
